        ...
        <div class="column view-profile">
                <form action="" class="column">
                    <div class="form-group column ">
                        ...
                        <input type="text" class="input-box font-family" value="<?php echo $user_name; ?>" disabled>
                    </div>
                    <div class="form-group column " >
                        <label  class="font-light label-size left font-family">EmailID:</label>
                        <input type="text" class="input-box font-family" value="<?php echo $user_email ?>" disabled>
                    </div>
                    <div class="form-group column " >
                        <label  class="font-light label-size left font-family">Phone No:</label>
                        <input type="text" class="input-box font-family" value="<?php echo $user_mobile ?>" disabled>
                    </div>
                    <div class="form-group column " >
                        <label  class="font-light label-size left font-family">Address:</label>
                        <textarea rows="4" cols="20" name="address" class="font-family" disabled ><?php echo $user_address ?></textarea>
                    </div>
                </form>
        </div>
